...
/**
 * Created by johnteng on 2017-04-26.
 */
...
public class deleteme {
    ...
    public deleteme(String title, Double rating, int length, String image, int rank, String id, String released, Double popularity, int votecount) {
        this.title = title;
        this.rating = rating;
        this.length = length;
        this.image = image;
